...
export interface TestAaveAdapterADAIInterface extends utils.Interface {
  functions: {
...
export interface TestAaveAdapterADAI extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestAaveAdapterADAIInterface;
