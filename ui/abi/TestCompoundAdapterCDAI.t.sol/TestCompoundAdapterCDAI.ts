...
export interface TestCompoundAdapterCDAIInterface extends utils.Interface {
  functions: {
...
export interface TestCompoundAdapterCDAI extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestCompoundAdapterCDAIInterface;
