...
export interface TestAaveAdapterCDAIInterface extends utils.Interface {
  functions: {
...
export interface TestAaveAdapterCDAI extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestAaveAdapterCDAIInterface;
