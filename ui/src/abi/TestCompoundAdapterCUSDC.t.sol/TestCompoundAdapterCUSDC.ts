...
export interface TestCompoundAdapterCUSDCInterface extends utils.Interface {
  functions: {
...
export interface TestCompoundAdapterCUSDC extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestCompoundAdapterCUSDCInterface;
