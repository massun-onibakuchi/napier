...
export interface TestEulerAdapterEDAIInterface extends utils.Interface {
  functions: {
...
export interface TestEulerAdapterEDAI extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestEulerAdapterEDAIInterface;
