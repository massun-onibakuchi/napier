...
export interface TestYearnAdapterYDAIInterface extends utils.Interface {
  functions: {
...
export interface TestYearnAdapterYDAI extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestYearnAdapterYDAIInterface;
